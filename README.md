...
**用 200 个产品案例，帮你判断真需求、找到相似路径、避开失败陷阱，并把想法收束成一个今天就能动手的原型。**
...
[效果示例](#效果示例) · [怎么使用](#怎么使用) · [能做什么](#能做什么) · [怎么做的](#怎么做的) · [局限](#局限)
...
| **成功案例类比** | 从 200 个案例里找相似路径 | 3-5 个相似成功案例，附来源链接 |
